...
var SAPPHIRE_FULL_LIB = (function(){
	...
	sapphire_full_lib.prototype= {
		...
		plotMetricDataFromAgentProxyUrl: function(metric_name, metrics_lable_name, index){
			...
			var evpsTrueUrlText = "http://cmevpsqry.vip.stratus.slc.ebay.com:8080/q?start=" + duration +"&m=" +aggregateMethod+ ":"+metricName+"%7Bfqdn="+fqdn+"%7D&format=json";

			var evpsTrueUrlGraph = "http://cmevpsqry.vip.stratus.slc.ebay.com:8080/q?start=" + duration +"&m=" +aggregateMethod+ ":"+metricName+"%7Bfqdn="+fqdn+"%7D&format=png";
			var that = this;
			$.ajax({
