...
class TestManifest(TestController):
    ...
    def testReadNestJsonServiceMeta(self):
        pass
#        pylons.config['agent_root'] = 'd:/'
#        manifestutil.updateServiceMetaFile('agent', None, {'config_override': {'config1': 'value1', 'config2': 'value2'}}, 1)
#        value = manifestutil.readNestJsonServiceMeta('agent', 'config_override', ['config1'])
#        assert value == 'value1'
#        value = manifestutil.readNestJsonServiceMeta('agent', 'config_override', ['config3'])
