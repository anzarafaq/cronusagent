...
ERROR = '''{"errorMsg": "service.eba deployment failed!<br><br> Using GERONIMO_HOME: /ebay/cronus/software/service_nodes/.ENVacysyhksozwg"}'''
...
if __name__ == '__main__':
    ...
    #/ENVhro7bjz48qu4b/testapps-app__ENVhro7bjz48qu4b/testapps-app__ENVhro7bjz48qu4b-PHX-CLhro7c6dn8fv4c-00001
#    propSet = ['odbMoName', 'cronusType', 'label', 'classOfService']
#    prefix = ''
#    stateclient = StateServerClient("state.vip.phx.ebay.com", int("12000"), ssl = False, credentials = None)        
#    entities = stateclient.queryEntities(path, limit=1)
#    print entities
    ...
    print os.path.dirname('/ebay/cronus/software/service_nodes/.SRPTest2.SRPTest2-SRPAppService.SRPTest2-instance6/.appdata')
...
#    httpPost('https://cl-ucloud050.cloud.qa.ebay.com:12020/agent/reloadmonitors', headers)
    url = 'http://xyz.ebay.com:8080/path1/path2?param1=value1'
    data = urlparse.urlparse(url)
    #data = package.PackageUtil.parseUri(url, path='test')
    print data
...
#    
#    ht = HttpThread(None, 'https', 'cl-ucloud010.cloud.qa.ebay.com', 12020, '/agent/agenthealth', 'dummy')
#    ht.start()
#    ht.join(5)
#    status = ht.getStatus()
#    error = status['error']
