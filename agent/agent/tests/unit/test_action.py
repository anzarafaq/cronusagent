...
#         response1 = self.app.post(url(controller='action', action='activatemanifest', service=service),
#                                        headers = {'Content-Type' : 'application/json'},
#                                        params = body)
...
#         try:
#             response2 = self.app.post(url(controller='action', action='activatemanifest', service=service),
#                                        headers = {'Content-Type' : 'application/json'},
#                                        params = body)
#             self.assertFalse(True, 'Expected an exception but did not get one!')
#         except AppError:
