...
my $request = '{"packageloc": "ebox-1.0.0.win.cronus", "trackerlist": "10.254.56.57:8998"}';
#my $request = '{"packageloc": "E705_CORE_BUNDLED_12652435_R1.ZIP", "trackerlist": "10.254.56.57:8998"}';

my $uripath = "http://localhost:11020/services/dist/gentorrent";
